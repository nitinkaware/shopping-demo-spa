...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'checkout-address': function checkoutAddress() {
      return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ../../Shared/Address */ "./resources/js/Shared/Address.vue"));
    },
    'address-modal': function addressModal() {
      return __webpack_require__.e(/*! import() */ 7).then(__webpack_require__.bind(null, /*! ../../Modals/Address */ "./resources/js/Modals/Address.vue"));
    }
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    this.request.submit('get', route('api.my.address.index')).then(function (response) {
      ...
      _this.order = response.cart.order;
    });
  },
