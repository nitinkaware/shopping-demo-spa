...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'cart-quantity-size': function cartQuantitySize() {
      return __webpack_require__.e(/*! import() */ 10).then(__webpack_require__.bind(null, /*! ../../Modals/UpdateSizeQuantity */ "./resources/js/Modals/UpdateSizeQuantity.vue"));
    }
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    this.request.submit('get', route('cart.index')).then(function (response) {});
  },
  computed: {
      ...
      swal({
        ...
        if (result.value) {
          axios["delete"](route('api.checkout.cart.destroy', cartId)).then(function (response) {
            _this.itemsInCart = response.data.data;

            _this.$root.$emit('removedFromCart', {
              itemsInCartCount: _this.itemsInCart.length
            });
        ...
        : _c("div", { staticClass: "col-12" }, [
            ...
            _c("div", [
              _c(
                "button",
                {
                  staticClass: "btn btn-primary pull-right text-uppercase",
