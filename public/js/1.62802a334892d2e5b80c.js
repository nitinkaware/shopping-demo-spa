...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    debugger;
    var slug = this.$route.params && this.$route.params.slug ? route('api.products.all.index', {
      category: this.$route.params.slug
    }) : route('api.products.all.index', slug);
    this.request.submit('get', route('api.products.all.index', slug)).then(function (response) {
