...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      this.form.post(route('login'), this.loginForm).then(function (response) {
        form_object__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.axios.headers.common["X-CSRF-TOKEN"] = response.csrfToken; // Redirect to Intended Location.
        // If success, direct to home page or back page.
      });
    }
  }
});
