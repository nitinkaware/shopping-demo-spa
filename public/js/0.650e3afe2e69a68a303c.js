...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    'filter-by-category': function filterByCategory() {
      return __webpack_require__.e(/*! import() */ 14).then(__webpack_require__.bind(null, /*! ../../Shared/FilterByCategory */ "./resources/js/Shared/FilterByCategory.vue"));
    }
  },
  props: ['route'],
  data: function data() {
  ...
  methods: {
    fetchProducts: function fetchProducts() {
      ...
      var compiledRoute = this.$route.params && this.$route.params.slug ? route('api.products.all.index', {
        category: this.$route.params.slug
      }) : route('api.products.all.index');
      this.request.submit('get', compiledRoute).then(function (response) {
