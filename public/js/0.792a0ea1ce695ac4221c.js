...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'product': function product() {
      return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '../Shared/Products.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
    },
    'filter-by-category': function filterByCategory() {
      return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '../Shared/FilterByCategory'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
    }
  },
  props: ['route'],
  data: function data() {
  ...
  mounted: function mounted() {
    ...
    this.request.submit('get', route('api.products.all.index')).then(function (response) {
